...
/***/ function(module, exports, __webpack_require__) {
	...
	var store = redux.createStore(__webpack_require__(46), { exercises: exs.sort(sortByName) });
...
/***/ function(module, exports, __webpack_require__) {
	...
	riot.tag2('exercise-app', '<div class="class={col-xs-12: true, col-sm-6: true, hidden-xs: this.state.panelView != \'LIST_VIEW\'}"> <search updatelist="{updateList}"></search> <button onclick="{setAddView}" type="button" class="btn btn-default full-width mb5 inline-item color2 item-selecter hidden-xs">Add Exercise</button> <img onclick="{setAddView}" src="/images/add.svg" class="mobile-nav-btn visible-xs"> <exercise-list exercises="{this.state.exercises}" selectexercise="{selectExercise}"></exercise-list> </div> <div class="{col-xs-12: true, col-sm-6: true, hidden-xs: this.state.panelView != \'DETAIL_VIEW\'}"> <img src="/images/back.svg" class="mobile-nav-btn visible-xs" onclick="{setListView}"> <ul class="nav nav-tabs nav-justified mb15"> <li onclick="{setExerciseView}" class="{active: this.state.detailView == \'EXERCISE_VIEW\'}"><a>Exercise</a></li> <li onclick="{setEditView}" class="{active: this.state.detailView == \'EDIT_VIEW\'}"> <a> {this.state.exercises[this.state.detail].name} logs <span class="glyphicon glyphicon-list-alt"></span> </a> </li> </ul> <exercise-detail show="{this.state.detailView == \'EXERCISE_VIEW\'}" exercise="{this.state.exercises[this.state.detail]}"></exercise-detail> <exercise-edit show="{this.state.detailView == \'EDIT_VIEW\'}" exercise="{this.state.exercises[this.state.detail]}"></exercise-edit> </div> <exercise-add show="{this.state.addView}" tags="{this.state.tags}" addexercise="{addExercise}" addtag="{addTag}" closeaddview="{closeAddView}" deletetag="{deleteTag}"></exercise-add>', '', '', function(opts) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	riot.tag2('exercise-list', '<div class="inline-item mb5 item-selecter color1" each="{exercise, index in this.opts.exercises}" show="{exercise.visible}" onclick="{getExercise}"> {exercise.name} </div>', '', '', function(opts) {
